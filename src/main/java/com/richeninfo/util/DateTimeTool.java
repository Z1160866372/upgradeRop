...
public class DateTimeTool {
    ...
    static {
    	simpleDateFormatMap.put(FORMAT_MONTH, new SimpleDateFormat(FORMAT_MONTH));
    ...
    private static SimpleDateFormat getSimpleDateFormat(String formatStyle) {
        ...
        if (Objects.requireNonNull(dateFormat) != null) {
            return dateFormat;
        }
    ...
    /**
     * 将 Date 格式时间转化为 yyyy-MM 格式时间
     *
     * @param date Date 格式时间
     * @return yyyy-MM 格式时间（如：2023-06）
     */
   ...
   /* 	SimpleDateFormat nowdate= getSimpleDateFormat(FORMAT_MONTH);
    	String newtime =format(new Date(),FORMAT_NO_DATE);
    	System.out.print("时间转换==="+newtime);
    	int a =getWeek(new Date());
    	System.out.print("今天是周"+a);
    	 Calendar calendar = Calendar.getInstance();
    	 int month = calendar.get(Calendar.MONTH) + 1;
    	 System.out.println("本月是"+month);
    	 if((month)==5){
    		 System.out.println("55555"+month);
    	 }else{
    		 System.out.println("ci月是"+month);
    	 }
...
//        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        // 本周工作日 日期
        // 星期一
       // System.out.println(dateFormat.format(getWeekDay()[0]));
        // 星期五
      // System.out.println(df.format(getWeekDay()[4]));
        // 判断某个日期是否在本周工作日内
    	/*String count="1";
       String abc=	Double.valueOf(count)>0 ? "1":"2";
       System.out.println("abc==="+abc);*/
    	 /*System.out.println(df.format(getWeekDay()[4]));
    	 System.out.println("abc==="+df.format(getLastWeek5()));
    	 System.out.println("abc==="+df.format(getLastWeek5()));*/
    ...
    public static Date[] getWeekDay() {
        Calendar calendar = Calendar.getInstance();
        System.out.println("1111="+calendar.get(Calendar.DAY_OF_WEEK));
        System.out.println("22222="+calendar.get(Calendar.MONDAY));
...
//        calendar.setFirstDayOfWeek();
    ...
    public static Date[] getWeekDay2() {
        Calendar calendar = Calendar.getInstance();
        while (calendar.get(Calendar.DAY_OF_WEEK) != Calendar.MONDAY) {
            calendar.add(Calendar.DAY_OF_WEEK, -1);
        }
