    ...
    JSONObject initializeUser(@ApiParam(name = "secToken", value = "用户标识", required = true) String secToken, @ApiParam(name = "channelId", value = "参与渠道", required = true) String channelId, @ApiParam(name = "actId", value = "活动编号", required = true) String actId) throws IOException {
        ...
        if (secToken.isEmpty()) {
            ...
            if (mobile.isEmpty()) {
                ...
                JSONObject object1 = miguFlowService.initializeUser(mobile, secToken, channelId, actId);
    ...
    JSONObject getActGift(@ApiParam(name = "secToken", value = "用户标识", required = true) String secToken, @ApiParam(name = "channelId", value = "参与渠道", required = true) String channelId, @ApiParam(name = "actId", value = "活动编号", required = true) String actId,String randCode,String wtAcId, String wtAc) throws IOException {
        ...
        if (secToken.isEmpty()) {
            ...
            if (mobile.isEmpty()) {
                ...
                JSONObject object1 = miguFlowService.getActGift(mobile, secToken, channelId, actId,randCode, wtAcId,  wtAc);
                object.put("data", object1);
            }
        }
        return object;
    ...
    JSONObject videoList(@ApiParam(name = "secToken", value = "用户标识", required = true) String secToken, @ApiParam(name = "channelId", value = "参与渠道", required = true) String channelId, @ApiParam(name = "actId", value = "活动编号", required = true) String actId) throws IOException {
        ...
        if (secToken.isEmpty()) {
            ...
            if (mobile.isEmpty()) {
                ...
                JSONObject object1 = miguFlowService.selectVideoList(mobile, secToken, channelId, actId);
                object.put(Constant.MSG, Constant.SUCCESS);
                object.put("data", object1);
            }
        }
