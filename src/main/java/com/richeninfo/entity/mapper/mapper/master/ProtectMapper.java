...
public interface ProtectMapper {
    ...
    @Insert("insert into wt_trade_user(userId,channelId,secToken,createDate,createTime,actId,belongFlag,note)values(#{userId},#{channelId},#{secToken},#{createDate},now(),#{actId},#{belongFlag},#{note})")
