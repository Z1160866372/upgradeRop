...
public class EncryptionForString {
    ...
    public static byte[] encrypt(byte[] keyIV, String strIn, Key key, String encoding) throws Exception {
        return encrypt(keyIV, strIn, key, "desede", encoding);
    }

    public static byte[] decrypt(byte[] keyIV, byte[] bIn, byte[] seed, String strKeyArithmetic, String strArithmetic,
    ...
    public static byte[] decrypt(byte[] keyIV, byte[] bIn, Key key) throws Exception {
        return decrypt(keyIV, bIn, key, "desede", "RAW");
    }

    public static byte[] decrypt(byte[] keyIV, byte[] bIn, String strKey) throws Exception {
